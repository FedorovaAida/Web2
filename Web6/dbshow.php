                ...
                foreach ($values as $value) {
                    ...
                    echo        '</select>
                            ...
                            <td>
                                ...
                                <div class="column-item">
                                    <input type="radio" id="radioLeft'.$value['application_id'].'" name="limbs'.$value['application_id'].'" value="8" '; if ($value['limbs'] == '8') echo 'checked'; echo '>
                                    <label for="radioLeft'.$value['application_id'].'">8</label>
                                </div>
                            </td>';
